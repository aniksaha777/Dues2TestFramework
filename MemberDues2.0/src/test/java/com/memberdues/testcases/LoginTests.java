...
import com.memberdues.pages.TokenEntryPage;
...
public class LoginTests extends BaseClass {
	...
	public void Login_to_Member_Portal() {
		...
		TokenEntryPage tokenPage = PageFactory.initElements(driver, TokenEntryPage.class);
		LoginPage loginPage = PageFactory.initElements(driver, LoginPage.class);
		// Start Application
		logger.info("Starting Application");
		Helper.captureScreenshot(driver, testcasename);
		
		tokenPage.Enter_token(token);
		loginPage.EnterUserDetails(uname, pw);
		//loginPage.HandleCaptcha(testcasename);
