...
public class FirstResetPasswordPage{
	...
	public void reset_Details(String OldPw, String newpw, String Q1Val, String Ans1, String Q2Val, String Ans2) {
		...
		Helper.highlightElement(driver, Question2);
	...
	public boolean isResetHeaderPresent() {
		try {
			Thread.sleep(1000);
		} catch (Exception e) {
